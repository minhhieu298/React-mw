...
import useChart from "./MyCharTest";
...
const ChartOption = () => {
  ...
  const { config } = useChart(data, indexValue);
  ...
  //           type !== "1day" ? getTimeString(index[1].x) : hour + ":" + minutes
  ...
  //     series: series,
  //   });
  // }, [arrPr, dataChartOption, dataCol, dataSpline, indexValue, type]);
  useEffect(() => {
    Highcharts.chart("container__chart__time", config);
  }, []);
  return (
